...
def train(opt):
    ...
    #     content_dataset, batch_size=opt.batch_size, shuffle=False,
    #     # sampler=torch.utils.data.SequentialSampler(content_dataset),
    #     num_workers=opt.n_threads))
    # style_iter = iter(data.DataLoader(
    #     style_dataset, batch_size=opt.batch_size, shuffle=False,
    #     # sampler=torch.utils.data.SequentialSampler(style_dataset),
        # num_workers=opt.n_threads))
